package org.vendor.opensimplex2;
...
public class OpenSimplex2 {
    ...
    /**
     * 3D vendor.opensimplex2.OpenSimplex2 noise, with better visual isotropy in (X, Y).
    ...
    /**
     * 3D vendor.opensimplex2.OpenSimplex2 noise, with better visual isotropy in (X, Z).
     * Recommended for 3D terrain and time-varied animations.
    ...
    /**
     * 3D vendor.opensimplex2.OpenSimplex2 noise, fallback rotation option
    ...
    /**
     * Generate overlapping cubic lattices for 3D vendor.opensimplex2.OpenSimplex2 noise.
     */
    ...
    /**
     * 4D vendor.opensimplex2.OpenSimplex2 noise, with XYZ oriented like noise3_ImproveXY
    ...
    /**
     * 4D vendor.opensimplex2.OpenSimplex2 noise, with XYZ oriented like noise3_ImproveXZ
     * and W for an extra degree of freedom. W repeats eventually.
     * Recommended for time-varied animations which texture a 3D object (W=time)
    ...
    /**
     * 4D vendor.opensimplex2.OpenSimplex2 noise, with XYZ oriented like noise3_Fallback
     * and W for an extra degree of freedom. W repeats eventually.
     * Recommended for time-varied animations which texture a 3D object (W=time)
    ...
    /**
     * 4D vendor.opensimplex2.OpenSimplex2 noise, with XY and ZW forming orthogonal triangular-based planes.
    ...
    /**
     * 4D vendor.opensimplex2.OpenSimplex2 noise, fallback lattice orientation.
     */
    ...
    /**
     * 4D vendor.opensimplex2.OpenSimplex2 noise base.
     */
